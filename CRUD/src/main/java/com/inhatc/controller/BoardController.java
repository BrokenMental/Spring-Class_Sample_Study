...
public class BoardController {
  ...
  public void MyRegisterGET(BoardVO board, Model model) throws Exception {
  ...
  @RequestMapping(value = "/MyRegis ter", method = RequestMethod.POST)
  public String MyRegistPOST(BoardVO board, RedirectAttributes rttr) throws Exception {

    logger.info("regist post ...........");
    logger.info(board.toString());

    board.setTitle(board.getTitle()+ board.getTitle());
    service.regist(board);
